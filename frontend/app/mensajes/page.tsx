              ...
              <div key={m.id} className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div className="flex items-center justify-between px-5 py-3 bg-slate-50 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-slate-800">{destinatario}</p>
                ...
                <div className="flex items-center justify-between px-5 py-3 border-t border-slate-100 bg-slate-50">
                  ...
                  <div className="flex items-center gap-2">
                    {lead.telefono_whatsapp && (
                      <button
                        onClick={() => abrirWhatsApp(lead.telefono_whatsapp!, mensajeActual)}
                        className="flex items-center gap-1.5 px-4 py-1.5 bg-green-600 text-white text-xs font-medium rounded-lg hover:bg-green-700 transition-colors"
                      >
